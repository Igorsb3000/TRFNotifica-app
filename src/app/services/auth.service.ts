...
import { AuthConst } from '../core/core/auth/auth.const';
import { ICredencial, IUsuario } from '../models/credencial';
...
export class AuthService extends BaseService{
  ...
  irPaginaLogin(): void {
    ...
    if (currentUrl.includes('search-results') || currentUrl.includes('process-details') || currentUrl.includes('my-processes') || currentUrl.includes('profile')) {
